...
import { Home, FolderOpen, FileText, Users, Bell, User, LogOut } from 'lucide-react'
        ...
        <div className="flex items-stretch">
          ...
          <div className="relative flex">
            <button
              ...
              className="flex items-center gap-2 px-5 py-3 text-sm font-medium text-gray-300 hover:bg-[#052a18] hover:text-white transition-colors"
            >
              <User className="w-4 h-4" />
              Mi Cuenta
            </button>
            {showAccount && (
              <div className="absolute right-0 top-full w-56 bg-white border border-gray-200 rounded-b-lg shadow-lg py-2 z-30">
          ...
          <div className="relative flex">
            ...
            {showNotif && (
              <div className="absolute right-0 top-full w-72 bg-white border border-gray-200 rounded-b-lg shadow-lg py-2 z-30 max-h-80 overflow-y-auto">
